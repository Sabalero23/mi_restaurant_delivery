...
@media (max-width: 576px) {
    ...
    .dropdown-menu {
        min-width: 200px;
        font-size: 0.85rem;
        /* Ajustar posición en móviles pequeños */
...
function toggleNotifications() {
    ...
    if (isEnabled) {
        ...
        // Deshabilitar notificaciones si existe la función global
        ...
        // Habilitar notificaciones si existe la función global
        if (typeof window.notificationSoundsEnabled !== 'undefined') {
...
// Función auxiliar para mostrar notificaciones (si existe)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Sincronizar con variable global si existe
    if (typeof window.notificationSoundsEnabled !== 'undefined') {
