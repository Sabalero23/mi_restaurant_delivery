-- =============================================
-- Migración v2.2.8 - Actualización de Versión
-- =============================================
...
-- =============================================
-- Actualizar versión del sistema a 2.2.8
-- =============================================
UPDATE `settings` 
SET `setting_value` = '2.2.8' 
...
-- =============================================
INSERT INTO `settings` (`setting_key`, `setting_value`, `description`) 
VALUES ('migration_v227_date', NOW(), 'Fecha de migración a v2.2.8')
...
VALUES (
    'migration_v227_log', 
    'Actualización de sistema v2.2.8 Correcciones en contadores de archivos durante actualización, implementación de modal de detalles, mejoras en tracking de cambios.',
    'Log de cambios versión 2.2.8'
)
...
-- =============================================
SELECT 
    'Migración v2.2.8 completada exitosamente' AS status,
